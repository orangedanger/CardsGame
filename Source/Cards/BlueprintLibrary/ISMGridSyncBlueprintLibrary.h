...
public:
	UFUNCTION(BlueprintPure, Category = "ISM Grid Sync Blueprints")
	static FVector SnapToGrid(const FVector& StartCenter, const FVector& GridSize);
	...
	UFUNCTION(BlueprintPure, Category = "ISM Grid Sync Blueprints")
	static FIntPoint GetIndexFromWorldLocation(const FVector& WorldLocation,const AGridsActor* Grids);

	UFUNCTION(BlueprintPure, Category = "ISM Grid Sync Blueprints",meta = (DefaultToSelf = "WorldContext"))
	static UTileDataAsset* GetTileDataAsset(const UObject* WorldContext);
